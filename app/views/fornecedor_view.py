...
class Fornecedor_View:
    ...
    def preencher_campos(self, fornecedor: Fornecedor):
    ...
    def get_id_selecionado(self):
        ...
        selecionado = self.tbl_fornecedores.selection()
    ...
    def ler_dados_fornecedor(self):
        ...
        razao_social = self.txt_razao_social.get().strip()
        nome_fantasia = self.txt_nome_fantasia.get().strip()
        cnpj = self.txt_cnpj.get().strip()
